...
sealed class ColorStyle {
    ...
    class HEX(override val color: Int) : ColorStyle(){ constructor(color: Long): this(color.toInt()) }
}
fun LayoutBuilder<*>.progressBar(
    currentSupplier: IntSupplier,
    totalSupplier: IntSupplier,
    width: Int = 100,
    height: Int = 20,
    border: Int = 2,
    padding : Int = 1,
    processColorStyle: ColorStyle = ColorStyle.HEX(0xFFFFFFFF),
    barColorStyle: ColorStyle = ColorStyle.HEX(0xFF00FF00),
    borderColorStyle: ColorStyle = ColorStyle.HEX(0xFF000000),
){
...
fun LayoutBuilder<*>.test(
    aSupplier: IntSupplier
){
