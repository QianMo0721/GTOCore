...
public final class MultiBlockA {
    ...
    public static final MultiblockMachineDefinition LARGE_STEAM_MACERATOR = multiblock("large_steam_macerator", "大型蒸汽研磨机", LargeSteamMultiblockMachine::new)
            ...
            .steamOverclock()
            .block(GTBlocks.CASING_BRONZE_BRICKS)
            .pattern(definition -> FactoryBlockPattern.start(definition, BACK, RelativeDirection.UP, LEFT)
    ...
    public static final MultiblockMachineDefinition PARTICLE_STREAM_MATRIX_FILLING_MACHINE = multiblock("particle_stream_matrix_filling_machine", "粒子流矩阵封装机", CrossRecipeMultiblockMachine::createHatchParallel)
            ...
            .pattern(definition -> FactoryBlockPattern.start(definition)
                    ...
                    .aisle("ACCCCCCCCCCCCCA", "ADDDDDDDDDDDDDA", "AD     D     DA", "AD     D     DA", "AD     D     DA", "AD     D     DA", "ADDDDDDDDDDDDDA", " D     D     D ", " DDDDDDDDDDDDD ", " D           D ", " DDDDDDDDDDDDD ", " D     D     D ", "BDDDDDDDDDDDDDB", "BBBBBBBBBBBBBBB", " FFF   M   FFF ", "  FJ   M   JF  ", "  FJ   M   JF  ", "  FJ MMMMM JF  ", "  FJ   M   JF  ", "  FJ   M   JF  ", "  FJ MMMMM JF  ", "  FJ   M   JF  ", "  FJ   M   JF  ", "  FJ MMMMM JF  ", "  FJ   M   JF  ", "  FJ   M   JF  ", "  FJ MMMMM JF  ", "  FJ   M   JF  ", "  FJ   M   JF  ", "  FJ MMMMM JF  ", "  FJ   M   JF  ", "  FJ   M   JF  ", "  FFFFFFFFFFF  ", "  GGLLGGGLLGG  ", "  G LEG GEL G  ", "  G LE   EL G  ", "   GLE   ELG   ", "   GLLG GLLG   ", "   GFFGGGFFG   ", "   FFDIGIDFF   ", "  FFBBIGIBBFF  ", "     EIGIE     ", "     EIGIE     ", "     EIGIE     ", "  FFBBLLLBBFF  ", "   FFFDDDFFF   ")
                    .aisle("ACCCCCCCCCCCCCA", "ADDDDDDDDDDDDDA", "AD  K K K K  DA", "AD  K K K K  DA", "AD  K K K K  DA", "AD  K K K K  DA", "AD  K KDK K  DA", " E IK K K KI E ", " D  K KDK K  D ", " E IK K K KI E ", " D  K KDK K  D ", " E IK K K KI E ", "BD  K KDK K  DB", "BBBBKKKBKKKBBBB", "  FF  O O  FF  ", "   J  O O  J   ", "   J  O O  J   ", "   J MOMOM J   ", "   J  O O  J   ", "   J  O O  J   ", "   J MOMOM J   ", "   J  O O  J   ", "   J  O O  J   ", "   J MOMOM J   ", "   J  O O  J   ", "   J  O O  J   ", "   J MOMOM J   ", "   J  O O  J   ", "   J  O O  J   ", "   J MOMOM J   ", "   J  O O  J   ", "   J  O O  J   ", "   FFFOFOFFF   ", "   G LKGKL G   ", "     E G E     ", "     E   E     ", "     E   E     ", "     L G L     ", "    FFKGKFF    ", "     DKIKD     ", "  F BBKIKBB F  ", "    BNKIKNB    ", "    BNKIKNB    ", "    BNKIKNB    ", "  F BBLLLBB F  ", "      DDD      ")
                    .aisle("ACCCCCCCCCCCCCA", "ADDDDDDDDDDDDDA", " DD         DD ", " DD         DD ", " DD         DD ", "ADD         DDA", "ADD    D    DDA", " EE I     I EE ", " DD    D    DD ", " EE I     I EE ", " DD    D    DD ", " EE I     I EE ", "BDD    D    DDB", " BBBBKKBKKBBBB ", "  FFF     FFF  ", "   JJ     JJ   ", "   JJ     JJ   ", "   JJMMMMMJJ   ", "   JJ     JJ   ", "   JJ     JJ   ", "   JJMMMMMJJ   ", "   JJ     JJ   ", "   JJ     JJ   ", "   JJMMMMMJJ   ", "   JJ     JJ   ", "   JJ     JJ   ", "   JJMMMMMJJ   ", "   JJ     JJ   ", "   JJ     JJ   ", "   JJMMMMMJJ   ", "   JJ     JJ   ", "   JJ     JJ   ", "   FFFFFFFFF   ", "   G LLLLL G   ", "     EEEEE     ", "     EEEEE     ", "     EEEEE     ", "     LLLLL     ", "     FFFFF     ", "      DDD      ", "  F BBBBBBB F  ", "    BBNENBB    ", "    BBNENBB    ", "    BBNENBB    ", "  F BBBBBBB F  ", "       F       ")
                    .aisle("ACCCCCCCCCCCCCA", "ACDDDDDDDDDDDCA", " CDD  K K  DDC ", " CDD  K K  DDC ", " CDD  K K  DDC ", "ACDD  K K  DDCA", "ACDD  KDK  DDCA", "  ED IK KI DE  ", "  DD  KDK  DD  ", "  ED IK KI DE  ", "  DD  KDK  DD  ", "  ED IK KI DE  ", " BDD  KDK  DDB ", " BBBBBKBKBBBBB ", "   FFF   FFF   ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    JJ   JJ    ", "    FFFFFFF    ", "    G  L  G    ", "    G  L  G    ", "    G  L  G    ", "    G  L  G    ", "    G  L  G    ", "    G FFF G    ", "    G  F  G    ", "   FGBBBBBGF   ", "   FBBB BBBF   ", "   FBBB BBBF   ", "   FBBB BBBF   ", "   FGBBBBBGF   ", "       F       ")
                    .aisle(" CCCCCCCCCCCCC ", " CCDDDDDDDDDCC ", " CGDD     DDGC ", " CGDD     DDGC ", " CGDD     DDGC ", " CCDD     DDCC ", " CCDD  D  DDCC ", "   DD I I DD   ", "   DD  D  DD   ", "   DD I I DD   ", "   DD  D  DD   ", "   DD I I DD   ", "  BDD  D  DDB  ", "  BBBBBBBBBBB  ", "    FFFFFFF    ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     JJJJJ     ", "     FFFFF     ", "     GGGGG     ", "               ", "               ", "       G       ", "       G       ", "       G       ", "       F       ", "    F  F  F    ", "    F     F    ", "    F     F    ", "    F     F    ", "    F  F  F    ", "       F       ")
                    .aisle("  CCCCCCCCCCC  ", "  CCDDDDDDDCC  ", "   GDD   DDG   ", "   GDD   DDG   ", "   GDD   DDG   ", "  CCDD   DDCC  ", "  CCDD D DDCC  ", "  H EE   EE H  ", "  H DD D DD H  ", "  H EE   EE H  ", "  H DD D DD H  ", "  H EE   EE H  ", "  BBDD D DDBB  ", "   BBBBBBBBB   ", "     FFFFF     ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       F       ", "       G       ", "       G       ", "       G       ", "               ", "               ", "               ", "               ", "     FFFFF     ", "               ", "               ", "               ", "     FFFFF     ", "               ")
                    .aisle("   CCCCCCCCC   ", "   CCDDDDDCC   ", "   CCDDDDDCC   ", "   CCDDDDDCC   ", "   CCDDDDDCC   ", "   CCDDDDDCC   ", "   CCDDDDDCC   ", "     EEDEE     ", "     DDDDD     ", "     EEDEE     ", "     DDDDD     ", "     EEDEE     ", "    BDDDDDB    ", "    BBBBBBB    ", "       F       ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ")
                    .aisle("    AAAAAAA    ", "    AAAPAAA    ", "      AAA      ", "      AAA      ", "      AAA      ", "    AAAAAAA    ", "    AAAAAAA    ", "               ", "               ", "               ", "               ", "               ", "     BBBBB     ", "      BBB      ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ", "               ")
    ...
    public static final MultiblockMachineDefinition ATOMIC_ENERGY_EXCITATION_PLANT = multiblock("atomic_energy_excitation_plant", "原子能激发工厂", CoilMultiblockMachine.createCoilMachine(false, true))
            ...
            .pattern(definition -> FactoryBlockPattern.start(definition)
                    .aisle("            ABA            ", "            ABA            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("            ABA            ", "            ABA            ", "            ABA            ", "            ABA            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("     CCCCCCCCCCCCCCCCC     ", "     DEDDDDDDEDDDDDDED     ", "      EF     E     FE      ", "            ABA            ", "            GBG            ", "            GBG            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("    CCCCCCCCCCCCCCCCCCC    ", "    DDEEEEEEEEEEEEEEEDD    ", "      EEEEEEEEEEEEEEE      ", "       F  H  C  H  F       ", "       F  H  C  H  F       ", "          H GBG H          ", "            GBG            ", "            GBG            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("   CCCCCCCCCCCCCCCCCCCCC   ", "   DDEE             EEDD   ", "     EEE     E     EEE     ", "       CCCCCCCCCCCCC       ", "       CCCCCCCCCCCCC       ", "       BBBH  C  HBBB       ", "                           ", "            GBG            ", "            GBG            ", "            GBG            ", "                           ", "         FFFFFFFFF         ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DDEE    IIIIIII    EEDD  ", "    EEEE           EEEE    ", "      CC           CC      ", "      CCEEEEEEEEEEECC      ", "      F   H  C  H   F      ", "          H     H          ", "          H  C  H          ", "          H     H          ", "          H GBG H          ", "          H GBG H          ", "       FF H GBG H FF       ", "          H     H          ", "          H     H          ", "                           ", "                           ", "                           ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  EEE   II   I   II   EEE  ", "  EEEEE             EEEEE  ", "     CC             CC     ", "     CCEEEEEEEEEEEEECC     ", "     F   CCCCCCCCC   F     ", "                           ", "         CCCCCCCCC         ", "                           ", "         CCCCCCCCC         ", "                           ", "      F     GBG     F      ", "            GBG            ", "          H GBG H          ", "                           ", "                           ", "                           ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE   I   EEIEE   I   ED  ", "  FEEE     EEEEE     EEEF  ", "   FCC     JJJJJ     CCF   ", "   FCCEEEEEEEEEEEEEEECCF   ", "    B   CKKKKKKKKKC   B    ", "         KKKKKKKKK         ", "        CKKKKKKKKKC        ", "         KKKKKKKKK         ", "        CKKKKKKKKKC        ", "         KKKKKKKKK         ", "     F   CCCCCCCCC   F     ", "                           ", "          H GBG H          ", "            GBG            ", "            GBG            ", "             L             ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE  I  EE  I  EE  I  ED  ", "   E     EE     EE     E   ", "    C    EE     EE    C    ", "    CEEEEEEJJJJJEEEEEEC    ", "    B  CKK       KKC  B    ", "        KK       KK        ", "       CKK       KKC       ", "        KK       KK        ", "       CKK       KKC       ", "        KK       KK        ", "     F  CCEEEEEEECC  F     ", "                           ", "          H     H          ", "                           ", "            MNM            ", "            GLG            ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE  I E    I    E I  ED  ", "   E    E         E    E   ", "    C   E         E   C    ", "    CEEEEJJJJJJJJJEEEEC    ", "    B CKK         KKC B    ", "       KK         KK       ", "      CKK         KKC      ", "       KK         KK       ", "      CKK         KKC      ", "       KK         KK       ", "    F  CCEEEEEEEEECC  F    ", "         O CCCCC O         ", "         OHKKKKKHO         ", "           CCCCC           ", "            MNM            ", "            AAA            ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE I  E    I    E  I ED  ", "   E    E         E    E   ", "   HC   E         E   CH   ", "   HCEEEEJJJJJJJJJEEEECH   ", "   HHHCK           KCHHH   ", "     H K           K H     ", "     HCK           KCH     ", "     H K           K H     ", "     HCK           KCH     ", "     H K           K H     ", "    FH CEEEJJJJJEEEC HF    ", "     H    C     C    H     ", "     HHHHHN     NHHHHH     ", "          CCCCCCC          ", "            MNM            ", "                           ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE I E     I     E I ED  ", "   E   E           E   E   ", "    C  J           J  C    ", "    CEEEJJJJJJJJJJJEEEC    ", "      CK    PPP    KC      ", "       K           K       ", "      CK    PPP    KC      ", "       K           K       ", "      CK    PPP    KC      ", "       K           K       ", "    F  CEEJJPPPJJEEC  F    ", "         C       C         ", "         K  PPP  K         ", "         CCCCCCCCC         ", "            MNM            ", "                           ")
                    .aisle("AACCCCCCCCCCCCCCCCCCCCCCCAA", "AADE I E    III    E I EDAA", " A E   E    IPI    E   E A ", " AA C  J    IPI    J  C AA ", "  G CEEEJJJJIPIJJJJEEEC G  ", "  GG  CK   PIPIP   KC  GG  ", "   G   K    IPI    K   G   ", "   GG CK   PIPIP   KC GG   ", "    G  K    IPI    K  G    ", "    GGCK   PIPIP   KCGG    ", "     G K    IPI    K G     ", "    FGGCEEJPIPIPJEECGGF    ", "      G  C  IPI  C  G      ", "      GG K PIPIP K GG      ", "       G CCCNNNCCC G       ", "       GMMMMMNMMMMMG       ", "        GAA AAA  AG        ")
                    .aisle("BBCCCCCCCCCCCCCCCCCCCCCCCBB", "BBEE IIIIIIIIIIIIIIIII EEBB", " BEE   E    PIP    E   EEB ", " BBCC  J    PIP    J  CCBB ", "  BCCEEEJJJJPIPJJJJEEECCB  ", "  BBCCCK   PPIPP   KCCCBB  ", "   B   K    PIP    K   B   ", "   BBCCK   PPIPP   KCCBB   ", "    B  K    PIP    K  B    ", "    BBCK   PPIPP   KCBB    ", "     B K    PIP    K B     ", "    FBBCEEJPPIPPJEECBBF    ", "      B  C  PIP  C  B      ", "      BB K PPIPP K BB      ", "       B CCCNNNCCC B       ", "       BNNNNNNNNNNNB       ", "       LLAA AQA  ALL       ")
                    .aisle("AACCCCCCCCCCCCCCCCCCCCCCCAA", "AADE I E    III    E I EDAA", " A E   E    IPI    E   E A ", " AA C  J    IPI    J  C AA ", "  G CEEEJJJJIPIJJJJEEEC G  ", "  GG  CK   PIPIP   KC  GG  ", "   G   K    IPI    K   G   ", "   GG CK   PIPIP   KC GG   ", "    G  K    IPI    K  G    ", "    GGCK   PIPIP   KCGG    ", "     G K    IPI    K G     ", "    FGGCEEJPIPIPJEECGGF    ", "      G  C  IPI  C  G      ", "      GG K PIPIP K GG      ", "       G CCCNNNCCC G       ", "       GMMMMMNMMMMMG       ", "        GAA AAA  AG        ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE I E     I     E I ED  ", "   E   E           E   E   ", "    C  J           J  C    ", "    CEEEJJJJJJJJJJJEEEC    ", "      CK    PPP    KC      ", "       K           K       ", "      CK    PPP    KC      ", "       K           K       ", "      CK    PPP    KC      ", "       K           K       ", "    F  CEEJJPPPJJEEC  F    ", "         C       C         ", "         K  PPP  K         ", "         CCCCCCCCC         ", "            MNM            ", "                           ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE I  E    I    E  I ED  ", "   E    E         E    E   ", "   HC   E         E   CH   ", "   HCEEEEJJJJJJJJJEEEECH   ", "   HHHCK           KCHHH   ", "     H K           K H     ", "     HCK           KCH     ", "     H K           K H     ", "     HCK           KCH     ", "     H K           K H     ", "    FH CEEEJJJJJEEEC HF    ", "     H    C     C    H     ", "     HHHHHN     NHHHHH     ", "          CCCCCCC          ", "            MNM            ", "                           ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DE  I E    I    E I  ED  ", "   E    E         E    E   ", "    C   E         E   C    ", "    CEEEEJJJJJJJJJEEEEC    ", "    B CKK         KKC B    ", "       KK         KK       ", "      CKK         KKC      ", "       KK         KK       ", "      CKK         KKC      ", "       KK         KK       ", "    F  CCEEEEEEEEECC  F    ", "         O CCCCC O         ", "         OHKKKKKHO         ", "           CCCCC           ", "            MNM            ", "            AAA            ")
                    ...
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  EEE   II   I   II   EEE  ", "  EEEEE             EEEEE  ", "     CC             CC     ", "     CCEEEEEEEEEEEEECC     ", "     F   CCCCCCCCC   F     ", "                           ", "         CCCCCCCCC         ", "                           ", "         CCCCCCCCC         ", "                           ", "      F     GBG     F      ", "            GBG            ", "          H GBG H          ", "                           ", "                           ", "                           ")
                    .aisle("  CCCCCCCCCCCCCCCCCCCCCCC  ", "  DDEE    IIIIIII    EEDD  ", "    EEEE           EEEE    ", "      CC           CC      ", "      CCEEEEEEEEEEECC      ", "      F   H  C  H   F      ", "          H     H          ", "          H  C  H          ", "          H     H          ", "          H GBG H          ", "          H GBG H          ", "       FF H GBG H FF       ", "          H     H          ", "          H     H          ", "                           ", "                           ", "                           ")
                    .aisle("   CCCCCCCCCCCCCCCCCCCCC   ", "   DDEE             EEDD   ", "     EEE           EEE     ", "       CCCCCCCCCCCCC       ", "       CCCCCCCCCCCCC       ", "       BBBH  C  HBBB       ", "                           ", "            GBG            ", "            GBG            ", "            GBG            ", "                           ", "         FFFFFFFFF         ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("    CCCCCCCCCCCCCCCCCCC    ", "    DDEEEEEEEEEEEEEEEDD    ", "      EEEEEEEEEEEEEEE      ", "       F  H  C  H  F       ", "       F  H  C  H  F       ", "          H GBG H          ", "            GBG            ", "            GBG            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("     CCCCCCCCCCCCCCCCC     ", "     DEDDDDDDEDDDDDDED     ", "      EF     E     FE      ", "            ABA            ", "            GBG            ", "            GBG            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("            ABA            ", "            ABA            ", "            ABA            ", "            ABA            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
                    .aisle("            ABA            ", "            ABA            ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ", "                           ")
