...
import com.gtocore.common.entity.NukeBombEntity;
...
public final class NukeBombBlock extends GTExplosiveBlock {
    ...
    @Override
    protected @NotNull GTExplosiveEntity createEntity(@NotNull Level world, @NotNull BlockPos pos, LivingEntity exploder) {
