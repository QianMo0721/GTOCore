...
public final class GCYRecipes {
    ...
    private static void registerPartsRecipes(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapedRecipe(provider, "crushing_wheels", CRUSHING_WHEELS.asStack(), "TTT", "UCU",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "slicing_blades", SLICING_BLADES.asStack(), "PPP", "UCU", "UMU",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "electrolytic_cell", ELECTROLYTIC_CELL.asStack(), "WWW", "WCW",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "heat_vent", HEAT_VENT.asStack(), "PDP", "RLR", "PDP", 'P',
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk1", PARALLEL[IV].asStack(), "SZE", "ZHZ",
                "CZC", 'S', SENSOR_IV.asStack(), 'E', EMITTER_IV.asStack(), 'Z', LuV_CIRCUITS, 'H', HULL[IV].asStack(),
                'C', new MaterialEntry(cableGtDouble, Platinum));
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk2", PARALLEL[LuV].asStack(), "SZE",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk3", PARALLEL[ZPM].asStack(), "SZE",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk4", PARALLEL[UV].asStack(), "SZE", "ZHZ",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk5", PARALLEL[UHV].asStack(), "SZE", "ZHZ",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk6", PARALLEL[UEV].asStack(), "SZE", "ZHZ",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk7", PARALLEL[UIV].asStack(), "SZE", "ZHZ",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk8", PARALLEL[UXV].asStack(), "SZE", "ZHZ",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk9", PARALLEL[OpV].asStack(), "SZE", "ZHZ",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk10", PARALLEL[MAX].asStack(), "SZE", "ZHZ",
        ...
        // if (GTOCore.isSimple()) {
        // VanillaRecipeHelper.addShapedRecipe(provider, "parallel_hatch_mk0", PARALLEL[EV].asStack(), "SZE", "ZHZ",
