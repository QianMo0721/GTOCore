...
final class NanoForge {
    ...
    public static void init() {
        NANO_FORGE_RECIPES.recipeBuilder("gold_nanites")
                ...
                .inputItems(GTItems.SYSTEM_ON_CHIP.asItem(), 16)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("osmium_nanites")
                ...
                .inputItems(GTItems.SYSTEM_ON_CHIP.asItem(), 32)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("infuscolium_nanites")
                ...
                .inputItems(GTItems.ADVANCED_SYSTEM_ON_CHIP.asItem(), 64)
                .inputItems(GTItems.HIGHLY_ADVANCED_SOC.asItem(), 32)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("draconium_nanites")
                ...
                .inputItems(GTItems.HIGHLY_ADVANCED_SOC_WAFER.asItem(), 32)
                .inputItems(GTOItems.OPTICAL_RAM_WAFER.asItem(), 32)
                .inputItems(GTOItems.SIMPLE_OPTICAL_SOC.asItem(), 32)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("spacetime_nanites")
                ...
                .inputItems(GTOItems.EIGENFOLDED_KERR_MANIFOLD.asItem(), 4)
                .inputItems(GTOItems.SUPRACAUSAL_RAM_WAFER.asItem(), 16)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("neutronium_nanites")
                ...
                .inputItems(GTItems.SYSTEM_ON_CHIP.asItem(), 64)
                .inputItems(GTItems.ADVANCED_SYSTEM_ON_CHIP.asItem(), 32)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("naquadah_nanites")
                ...
                .inputItems(GTItems.ADVANCED_SYSTEM_ON_CHIP.asItem(), 16)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("black_dwarf_mtter_nanites")
                ...
                .inputItems(GTOItems.COSMIC_PROCESSING_UNIT_CORE.asItem(), 8)
                .inputFluids(GTMaterials.UUMatter.getFluid(40000))
        ...
        NANO_FORGE_RECIPES.recipeBuilder("transcendent_metal_nanites")
                ...
                .inputItems(GTOItems.RECURSIVELY_FOLDED_NEGATIVE_SPACE.asItem(), 8)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("eternity_nanites")
                ...
                .inputItems(GTOItems.CLOSED_TIMELIKE_CURVE_COMPUTATIONAL_UNIT.asItem(), 8)
        ...
        NANO_FORGE_RECIPES.recipeBuilder("cosmic_neutronium_nanites")
                ...
                .inputItems(GTOItems.SIMPLE_OPTICAL_SOC.asItem(), 32)
                .inputItems(GTOItems.EXOTIC_WAFER.asItem(), 32)
                .inputItems(GTOItems.COSMIC_RAM_WAFER.asItem(), 16)
                .inputItems(GTOItems.COSMIC_PROCESSING_UNIT_CORE.asItem(), 8)
                .inputFluids(GTMaterials.UUMatter.getFluid(40000))
