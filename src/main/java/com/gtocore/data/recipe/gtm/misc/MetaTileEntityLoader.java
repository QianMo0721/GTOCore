...
public final class MetaTileEntityLoader {
    ...
    // - MaterialEntry
    // - TagKey<?>
    private static void registerMachineRecipe(Consumer<FinishedRecipe> provider, boolean setMaterialInfoData,
    ...
    private static void registerMachineRecipe(Consumer<FinishedRecipe> provider, MachineDefinition[] machines,
                                              Object... recipe) {
