...
public final class CraftingRecipeLoader {
    ...
    public static void init() {
        ...
        VanillaRecipeHelper.addShapedRecipe("mana_ulv_prospector", PROSPECTOR_MANA_ULV.asStack(),
                "ASB", "EDE", "SCS",
        ...
        VanillaRecipeHelper.addShapedRecipe("mana_lv_prospector", PROSPECTOR_MANA_LV.asStack(),
                "ASB", "EDE", "SCS",
        ...
        VanillaRecipeHelper.addShapedRecipe("mana_hv_prospector", PROSPECTOR_MANA_HV.asStack(),
                "ASB", "EDE", "SCS",
        ...
        VanillaRecipeHelper.addShapedRecipe("machine_coordinate_card", COORDINATE_CARD.asStack(),
                " A ",
                "ABA",
                " A ",
